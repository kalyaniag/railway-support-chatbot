          ...
          <div className="space-y-3">
            <div className="p-3 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg border border-blue-200">
              <div className="text-center">
                ...
                <p className="text-3xl font-bold text-blue-600">₹{result.refundAmount.toFixed(2)}</p>
              </div>
            </div>
            ...
            {result.deductionPercentage < 100 && (
              <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-xs text-blue-800 flex items-start gap-2">
                  ...
                  <span>Refund will be credited to the original payment method. GST component is non-refundable.</span>
                </p>
              </div>
            )}
            ...
            {result.deductionPercentage === 100 && (
              <div className="p-3 bg-red-50 rounded-lg border border-red-200">
                <p className="text-xs text-red-800 flex items-start gap-2">
                  ...
                  <span>No refund available for this cancellation. {result.ticketType === 'Tatkal' ? 'Tatkal tickets are non-refundable.' : 'Cancellation too close to departure time.'}</span>
                </p>
              </div>
            )}
          </div>
